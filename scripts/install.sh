...
"$VENV_DIR/bin/pip" install --quiet -r "$INSTALL_DIR/requirements.txt" 2>/dev/null || true
ok "Dependencies installed (paho-mqtt, websockets, meshtastic, protobuf, pyopenssl)"
